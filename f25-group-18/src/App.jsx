  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      {types.map(({ icon: Icon, label, color }) => (
        <div
          key={label}
          className={`${bgColors[color]} rounded-2xl p-6 text-center flex flex-col items-center justify-center h-full min-h-[120px]`}
        >
          <Icon className={`w-8 h-8 mb-2 ${textColors[color]}`} />
